...
* Fixed bug when one installation attempt failed, it left msiexec running, preventing other attempts
...
* Changed some indentations or spaces to make the script consistent in it's layout
* set version number 6.0.2 in all places in the code
